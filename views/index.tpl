        ...
        <main class="eight columns mainrightcol">
            ...
            % for d in domains:
                ...
                % end
                    ...
                    <a target="_blank" rel="nofollow" href="/register/{{d}}" class="domain six columns alpha" data-opened="false"> <img class="domainicon" src="{{random_image_path}}"/><p class="domaintext">{{d}}</p></a>
                % if i % 2 != 0:
                    </div>
                % end
                % i += 1
